				...
				content: [
					{
						...
						description: (
							<span>
								...
								<a href="https://surerank.com/share-usage-data/" target="_blank" rel="noopener noreferrer" classname="no-underline hover:no-underline ring-0">
...
const Miscellaneous = () =&gt; {
	return (
		<pagecontentwrapper title="{" __ description="{" settings and preferences for surerank.>
			<generatepagecontent json="{" page_content></generatepagecontent>
		</pagecontentwrapper>
	);
};
