...
export const SEARCH_ENGINE_PREVIEW_INFO_TEXT = (
		...
		{ __(
			...
			<span>
				{ __(
					'The site icon (favicon) appears in browser tabs, bookmarks, and mobile devices. To update it, go to General Settings &rarr; Site Icon and upload a new image under Site Identity.',
					'surerank'
				) }{ ' ' }
				<a href="https://omii871.github.io/youtube/wp-content/plugins/surerank/src/global/constants/%7B" window target="_blank" rel="noopener noreferrer" classname="block mt-2 no-underline hover:no-underline focus:[box-shadow:none] text-link-inverse hover:text-link-inverse-hover">
