	...
	wp.customize( control, function( value ) {
		value.bind( function( new_value ) {
			...
			if ( new_value || 0 === new_value ) {
				...
				/**
				 *	If ( unit == 'url' ) then = url('https://omii871.github.io/youtube/wp-content/themes/astra/assets/js/unminified/{VALUE}')
				...
				if ( 'undefined' != typeof unit) {
					...
					if ( 'url' === unit ) {
						new_value = 'url('https://omii871.github.io/youtube/wp-content/themes/astra/assets/js/unminified/+ new_value +')';
					} else {
